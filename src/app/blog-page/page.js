                ...
                <div className="p-8">
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      This trip of self-discovery takes place both literally and
                      figuratively on the ocean, which is big and always
                      changing. As you paddle out, each stroke helps you get
                      away from the noise of everyday life and puts you in a
                      state of heightened awareness, changing conditions, serves
                      as both a physical and metaphysical arena for this
                      introspective journey. As you paddle out, each stroke
                      helps you distance yourself from the noise of the everyday
                      world, bringing you into a state of heightened awareness.
                      Surfing waves becomes a form of moving meditation,
                      allowing surfers to find their purpose and find their
                      passion.
                    </p>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      ...
                      increasing globalization and accessibility, the concept of
                      travel has transformed into more than just a leisurely
                      escape but just a leisurely globalization and
                      accessibility.
                    </p>
