      ...
      <div className="grid lg:grid-cols-12 gap-12 items-center">
        <div className="col-span-6">
          <p className="text-gray-600 mb-5 leading-relaxed">
            ...
            and Future Technologies, designed to serve the unique needs of urban
            and rural schools, colleges, and training institutes across India.
            Our integrated ecosystem empowers educators and institutions with
            everything they need to make learning hands-on, engaging, and
            future-ready:
          </p>
          ...
          <p className="text-gray-600 mb-5 leading-relaxed">
            ...
            <b> 21st-century</b> skills while ensuring sustained engagement and
            <b> measurable learning outcomes</b>.<br></br> If you have strong
            local connections and are passionate about transforming education in
            your community, we invite you to join hands with us. <br></br> Our
            partnership model is designed to help you build a reliable,
